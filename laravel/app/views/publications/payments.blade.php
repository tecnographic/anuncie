		...
		<div class="col-xs-12">
				...
				<div class="col-xs-12">
					...
					<legend>DEPÓSITO O TRANSFERENCIA BANCARIA:</legend>
						...
						Usted ha elegido la opción de pagar a través de TRANSFERENCIA O DEPÓSITO 
							...
							automáticamente
							Una vez haya realizado su pago, introduzca el número de transacción en la casilla</p>
					</div>
				</div>
				<div class="col-xs-12">
					<div class="col-xs-12" style="padding-left:0px;">
						<p class="textoPromedio">Una vez haya realizado su pago ya sea por deposito/transferencia o PayPal, introduzca el número de transacción en la casilla</p>
					...
					<div class="col-xs-12">
						<div class="col-xs-6" style="padding-left:0px;">
							...
							<div class="col-xs-12 formulario textoPromedio">
				                ...
				                <input type="text" class="form-control" name="emisor" required>
			...
			<div class="contAnaranjado">
				<div class="col-xs-12">
					...
					<p class="textoPromedio">En caso de no haber hecho depósito aún, Podra realizar su pago a través del siguiente botón</p>
					<div class="col-xs-12">
			...
			<div class="modal-content">
				...
				<form method="POST" action="">
					<div class="modal-body">
						<p class="textoPromedio">A continuación se desplegará una lista de bancos en los cuales podra hacer su transacción para completar la publicación en ffsail.</p>
