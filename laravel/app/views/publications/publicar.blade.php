	...
	<div class="row">
			...
			<div class="col-xs-10 col-sm-offset-1 contPubType contAnaranjado" style="margin-top:2em;">
				<div class="col-xs-12">
					<ol class="breadcrumb textoPromedio">
					 <li><a href="{{ URL::to('usuario/publicar') }}" class="breadcrums"><span class="num numActivo">1</span> Elije el tipo de publicación.</a></li>
					</ol>
				</div>
			...
			<div class="col-xs-4 publication">
				...
				<p class="textoPromedio footerText textoPublicacion">
					Anuncio LÍDER es un espacio privilegiado de publicidad que se encuentra en la sección de menú principal y categorías, le permite al usuario que el cliente visite su página web en caso de tenerla, además la comunidad anuncie24 se encarga de aumentar la publicidad de su anuncio a través de las principales redes sociales.
				</p>
			...
			<div class="col-xs-4 publication">
				...
				<p class="textoPromedio footerText textoPublicacion">
					Anuncio HABITUAL es una publicación destinada a productos y servicios, pudiendo determinar la categoría en la cual publicar, cada publicación tiene una duración de 70 días, ideal para el joven emprendedor permitiéndole adquirir reputación dentro de la comunidad anuncie24.
				</p>
