	...
	<div class="row">
		<div class="col-xs-12 contAnaranjado" style="margin-top:5em;">
			...
			<div class="col-xs-6 cotMyRep">
				<legend><h3>Reputacion como comprador</h3></legend>
			...
			<div class="modal-header">
				...
				<div class="modal-body">
					<ul class="textoPromedio">
						<li>La comunidad anuncie24.com ha creado un sistema de valoración para determinar la calidad de los productos así como también la calidad de atención al público.</li>
						<li>No trate de generar reputación utilizando programas o medios ilícitos, anuncie24.com cuenta con un sistema de gestión de usuarios y nos reservamos el derecho de eliminar al usuario que este ejerciendo este tipo de actividad.</li>
						<li>
						...
						<li>La comunidad anuncie24.com le desea éxitos, no olvide comunicarse al: atencionalclienteanuncie24@gmail.com estamos  para servirle.</li>
					</ul>
				</div>
