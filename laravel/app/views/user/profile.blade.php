			...
			<div class="col-xs-8 col-sm-offset-2 contForm contAnaranjado">
				...
				<form action="{{ URL::to('usuario/perfil/enviar') }}" method="POST">
					...
					<div class="col-xs-12 formulario">
						...
						<div class="col-xs-6 inputRegister">
							<p class="mdfInfo textoPromedio">{{ $user->zip_code }}</p>
							<input type="text" name="postal_cod" class="form-control mdfForm" placeholder="Codigo postal" id="zip_cod" value="{{ $user->zip_code }}">
					...
					<div class="col-xs-12 formulario">
						...
						<div class="col-xs-6 inputRegister">
							<p class="mdfInfo textoPromedio">{{ $user->zip_code }}</p>
							<input type="text" name="pais" class="form-control mdfForm" placeholder="Pais" id="zip_cod" value="{{ $user->pais }}">
