						...
						<div class="owl-carousel1">
							...
							<div class="item contCatIndex">
								...
								<div class="dataIndex textoPromedio">
									...
									<div class="col-xs-12"><a href="{{ URL::to('publicacion/lider/'.base64_encode($pubLider->id)) }}" style="color:white;"><i class="fa fa-hand-o-right"></i> Click para entrar en la publicación</a>
									</div>
								</div>
							</div>
							@endforeach
							...
							@foreach($habitual as $pubHabitual)
							 <div class="item contCatIndex">
								...
								<div class="dataIndex textoPromedio">
									...
									<div class="col-xs-6" style="padding-top:0px;margin-top:0px;"><label>Precio: </label>{{ $pubHabitual->precio.' '.ucfirst(strtolower($pubHabitual->moneda)).'.' }}</div>
									<div class="col-xs-12"><a href="{{ URL::to('publicacion/lider/'.base64_encode($pubHabitual->id)) }}" style="color:white;"><i class="fa fa-hand-o-right"></i> Click para entrar en la publicación</a>
									</div>
								</div>
							</div>
						...
						<div class="owl-carousel3">
							...
							<div class="item contCatIndex">
								...
								<div class="dataIndex textoPromedio">
									...
									<div class="col-xs-12"><a href="{{ URL::to('publicacion/lider/'.base64_encode($pubCasual->id)) }}" style="color:white;"><i class="fa fa-hand-o-right"></i> Click para entrar en la publicación</a>
									</div>
								</div>
							</div>
							@endforeach
